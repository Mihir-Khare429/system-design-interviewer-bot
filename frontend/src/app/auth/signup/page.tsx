      ...
      <div className="w-full max-w-sm rounded-xl border border-[#27272a] bg-[#111113] p-8">
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center text-xs text-[#52525b]">
            <span className="bg-[#111113] px-2">or sign up with email</span>
          </div>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-[#52525b]">
          ...
          <Link href="#" className="text-[#71717a] hover:text-[#e8e8e8]">Terms</Link>
          {" "}and{" "}
          <Link href="#" className="text-[#71717a] hover:text-[#e8e8e8]">Privacy Policy</Link>.
        </p>
